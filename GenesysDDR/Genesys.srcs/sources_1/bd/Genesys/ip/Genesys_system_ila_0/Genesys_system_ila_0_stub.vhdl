...
-- Date        : Tue Aug 11 14:41:35 2020
-- Host        : DESKTOP-N6DNGGG running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top Genesys_system_ila_0 -prefix
--               Genesys_system_ila_0_ Genesys_system_ila_0_stub.vhdl
-- Design      : Genesys_system_ila_0
...
entity Genesys_system_ila_0 is
  Port ( 
    clk : in STD_LOGIC;
...
end Genesys_system_ila_0;

architecture stub of Genesys_system_ila_0 is
...
attribute X_CORE_INFO of stub : architecture is "bd_c0ef,Vivado 2019.2";
begin
end;
